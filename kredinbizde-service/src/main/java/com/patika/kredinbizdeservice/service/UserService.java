...
public class UserService {
    ...
    public User save(User user) {
        ...
        //notification strategy üzerinden gönderilebilir.Ancak hangi tipte gönderileceği bilgisi bir config'e veya genelde son kullanıcıya sorulur.
        //Ona göre bir factory yaratılıp runtime da o tipte bildirim sınıfı alınıp ilerlenebilir. Onun dışında bir şey aklıma gelmedi.
